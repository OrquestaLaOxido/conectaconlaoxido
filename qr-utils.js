...
/* Dibuja el título (y el subtítulo, si lo hay) encima del QR
   en un canvas nuevo. Devuelve el canvas compuesto, sin descargarlo. */

function componerCanvasQR(canvasQR, titulo, subtitulo){
